...
MACRO(_PCH_GET_TARGET_COMPILE_FLAGS _cflags  _header_name _pch_path _dowarn )
  ...
  ELSE(CMAKE_COMPILER_IS_GNUCXX)
    ...
    set(${_cflags} "/Fp\"${_native_pch_path}\" /Yu\"${_header_name}\" /FI\"${_header_name}\" " )	
...
FUNCTION (ADD_MSVC_PRECOMPILED_HEADERS PrecompiledSource PrecompiledHeader TargetProject)
	IF (MSVC)
	...
	SET_PROPERTY(TARGET ${TargetProject}
		...
		"/Yu\"${PrecompiledHeader}\" /Fp\"${PrecompiledBinary}\" /FI\"${PrecompiledHeader}\"")
        # set the source file to compile out the pch
	SET_PROPERTY(SOURCE ${PrecompiledSource}
		APPEND
		PROPERTY COMPILE_FLAGS
		"/Yc\"${PrecompiledHeader}\" /Fp\"${PrecompiledBinary}\" /FI\"${PrecompiledHeader}\"")
	ENDIF (MSVC)
