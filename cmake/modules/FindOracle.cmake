...
GET_FILENAME_COMPONENT(XE18_HOME "[HKEY_LOCAL_MACHINE\\SOFTWARE\\ORACLE\\KEY_OraDB18Home1;ORACLE_HOME]" ABSOLUTE CACHE)
...
IF (NOT DEFINED ORACLE_OCI_VERSION AND ORACLE_INCLUDES)
  ...
  IF (${OCIVER_TYPE} GREATER "190")
    SET(ORACLE_OCI_VERSION "19C")
  ELSEIF (${OCIVER_TYPE} GREATER "180")
    SET(ORACLE_OCI_VERSION "18C")
  ELSEIF (${OCIVER_TYPE} GREATER "120")
