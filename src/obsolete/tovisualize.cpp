    ...
    : QWidget(parent), Source(source)
{
    ...
    QToolBar *toolbar = Utils::toAllocBar(this, tr("Data visualization"));
...
void toVisualize::display(void)
{
    ...
    case 0:
    {
        ...
        for (int row = 0; row < model->rowCount(); row++)
        {
            ...
            for (int i = tit; i < model->columnCount(); i++)
            {
                ...
                Utils::toPush(val, model->data(index, Qt::EditRole).toDouble());
            }
    ...
    case 1:
    {
        ...
        for (int i = tit; i < model->columnCount(); i++)
        {
            Utils::toPush(lst, model->headerData(
                              i,
                              Qt::Horizontal,
