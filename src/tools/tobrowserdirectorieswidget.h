...
*/
class toBrowserDirectoriesWidget : public toBrowserBaseWidget
{
        Q_OBJECT;

        toResultTableView *directoriesView;
        toResultCode *extractDirectory;
...
//Util::RegisterInFactory<toBrowserDirectoriesWidget, toBrowserWidgetFactory> regToBrowserDirectoriesWidget(???);
