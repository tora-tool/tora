...
//      Base* create (ClassIdKeyParm className) const {
//    	  typename FctRegistry::const_iterator regEntry(mRegistry.find(className));
//    	  return (regEntry == mRegistry.end() ? NULL : (*regEntry).second() );
//      }
...
//	  Base* create(ClassIdKeyParm className, P1Parm parm1) const {
//		  typename FctRegistry::const_iterator regEntry (mRegistry.find(className));
//		  return (regEntry == mRegistry.end() ? NULL : (*regEntry).second(parm1) );
//	  }
...
//	  Base* create(ClassIdKeyParm className, P1Parm parm1, P2Parm parm2) const
//	  {
//		  typename FctRegistry::const_iterator regEntry (mRegistry.find(className));
//		  return (regEntry == mRegistry.end() ? NULL : (*regEntry).second(parm1, parm2) );
//	  }
...
//    Base* create(ClassIdKeyParm className, P1Parm parm1, P2Parm parm2, P3Parm parm3) const
//    {
//    	typename FctRegistry::const_iterator regEntry (mRegistry.find(className));
//    	return (regEntry == mRegistry.end() ? NULL : (*regEntry).second(parm1, parm2, parm3) );
//    }
...
//    Base* create(ClassIdKeyParm className, P1Parm parm1, P2Parm parm2, P3Parm parm3, P4Parm parm4) const
//    {
//    	typename FctRegistry::const_iterator regEntry (mRegistry.find(className));
//    	return (regEntry == mRegistry.end() ? NULL : (*regEntry).second(parm1, parm2, parm3, parm4) );
//    }
