...
echo Building rpm tora$TYPE-$1-1underscore.i686.rpm 
rpm -bb tora-$1/rpm/tora-static.spec
cp /usr/src/RPM/RPMS/*/tora-$1-1static.*.rpm $SRCPWD/tora$TYPE-$1-1underscore.i686.rpm 

cd /usr/src/RPM/BUILD/tora-$1
strip tora-static
mv tora-static tora
cd ..
echo Packing tora$TYPE-$1-underscore.tar.gz
