...
cp /usr/src/RPM/RPMS/*/tora-$1-1gc.*.rpm ../tora$TYPE-$1-1gc-$GLIBC.i686.rpm 
cp /usr/src/RPM/RPMS/*/tora-mysql-$1-1gc.*.rpm ../tora-mysql$TYPE-$1-1gc-$GLIBC.i686.rpm 
cp /usr/src/RPM/RPMS/*/tora-oracle-$1-1gc.*.rpm ../tora-oracle$TYPE-$1-1gc-$GLIBC.i686.rpm 
...
then
	...
	tora-$1/BUGS tora-$1/NEWS tora-$1/INSTALL tora-$1/TODO tora-$1/templates/sqlfunctions.tpl \
	tora-$1/icons/tora.xpm tora-$1/icons/toramini.xpm tora-$1/help
    cp /usr/src/RPM/RPMS/*/tora-$1-1static.*.rpm ../tora$TYPE-$1-1static.i686.rpm 
else
    cd $SRCPWD
